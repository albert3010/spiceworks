...
/**
 * This class represents an practice.emoji.<br>
 * <br>
...
public class Emoji {
     ...
     *
     * @param description         The description of the practice.emoji
     * @param supportsFitzpatrick wether the practice.emoji supports the Fitzpatrick modifiers or not
     * @param aliases             the aliases for this practice.emoji
     * @param tags                the tags associated with this practice.emoji
     * @param bytes               the bytes that represent the practice.emoji
     */
    ...
    /**
     * Returns the description of the practice.emoji
     *
    ...
    /**
     * Returns wether the practice.emoji supports the Fitzpatrick modifiers or not
     *
     * @return true if the practice.emoji supports the Fitzpatrick modifiers
     */
    ...
    /**
     * Returns the aliases of the practice.emoji
     *
    ...
    /**
     * Returns the tags of the practice.emoji
     *
    ...
    /**
     * Returns the unicode representation of the practice.emoji
     *
    ...
    /**
     * Returns the unicode representation of the practice.emoji associated with the provided Fitzpatrick modifier.<br>
     * If the modifier is null, then the result is similar to {@link practice.emoji.Emoji#getUnicode()}
     *
     * @param fitzpatrick the fitzpatrick modifier or null
     *
     * @return the unicode representation
     * @throws UnsupportedOperationException if the practice.emoji doesn't support the Fitzpatrick modifiers
     */
    public String getUnicode(Fitzpatrick fitzpatrick) {
        if (!this.supportsFitzpatrick()) {
            throw new UnsupportedOperationException("Cannot get the unicode with a fitzpatrick modifier, the practice.emoji doesn't support fitzpatrick.");
    ...
    /**
     * Returns the HTML decimal representation of the practice.emoji
     *
    ...
    /**
     * Returns the HTML hexadecimal representation of the practice.emoji
     *
