package practice_lld.top25.lld.practice.splitwise.service;
...
import practice_lld.top25.lld.practice.splitwise.exception.ExpenseError;
import practice_lld.top25.lld.practice.splitwise.exception.ExpenseException;
...
public class SplitwiseService {
    ...
    public void addExpenseToGroup(Integer groupId, Expense expense) throws Exception {
        // check expence
        List<User> users = userDao.getUsers(groupId);
        // validate if all users present
        if(users == null){
            throw new ExpenseException(ExpenseError.GROUP_NOT_EXIST);
        }
