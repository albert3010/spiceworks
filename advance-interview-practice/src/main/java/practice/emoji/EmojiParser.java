...
public class EmojiParser {
    ...
    /**
     * See {@link #parseToAliases(String, practice.emoji.EmojiParser.FitzpatrickAction)} with the action "PARSE"
     *
    ...
    /**
     * Replaces the practice.emoji's unicode occurrences by one of their alias (between 2 ':').<br>
    ...
    /**
     * Replaces the practice.emoji's aliases (between 2 ':') occurrences and the html representations by their unicode.<br>
     * Examples:<br>
    ...
    /**
     * See {@link #parseToHtmlDecimal(String, practice.emoji.EmojiParser.FitzpatrickAction)} with the action "PARSE"
     *
     * @param input the string to parse
     *
    ...
    /**
     * Replaces the practice.emoji's unicode occurrences by their html representation.<br>
    ...
    /**
     * See {@link #parseToHtmlHexadecimal(String, practice.emoji.EmojiParser.FitzpatrickAction)} with the action "PARSE"
     *
     * @param input the string to parse
     *
    ...
    /**
     * Replaces the practice.emoji's unicode occurrences by their html hex representation.<br>
     * Example: <code>👦</code> will be replaced by <code>&amp;#x1f466;</code><br>
     * <br>
     ...
     *
     * @return the string without any practice.emoji
     */
    ...
    public enum FitzpatrickAction {
        /**
         * Tries to match the Fitzpatrick modifier with the previous practice.emoji
         */
        PARSE,
